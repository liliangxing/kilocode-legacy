...
- [Setting Up Authentication](setup-authentication.md) - Configure your AI provider
- [Your First Task](../code-with-ai/agents/chat-interface.md) - Learn the basics of working with Kilo Code
