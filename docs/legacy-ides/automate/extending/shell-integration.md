...
- Execute commands on your behalf through the [`execute_command`](../tools/execute-command.md) tool
...
![Terminal output limit slider set to 500](../../assets/img/shell-integration/terminal-output-limit.png)
_Terminal output limit slider set to 500_
...
![Terminal shell integration timeout slider set to 15s](../../assets/img/shell-integration/shell-integration-timeout.png)
_Terminal shell integration timeout slider set to 15s_
...
![Terminal command delay slider set to 0ms](../../assets/img/shell-integration/terminal-command-delay.png)
_Terminal command delay slider set to 0ms_
...
> **Important:** > **Terminal restart required for these settings**
>
...
![PowerShell counter workaround checkbox](../../assets/img/shell-integration/power-shell-workaround.png)
_PowerShell counter workaround checkbox_
...
![Clear ZSH EOL mark checkbox](../../assets/img/shell-integration/clear-zsh-eol-mark.png)
_Clear ZSH EOL mark checkbox_
...
![Enable Oh My Zsh integration checkbox](../../assets/img/shell-integration/oh-my-zsh.png)
_Enable Oh My Zsh integration checkbox_
...
![Enable Powerlevel10k integration checkbox](../../assets/img/shell-integration/power10k.png)
_Enable Powerlevel10k integration checkbox_
...
![Enable ZDOTDIR handling checkbox](../../assets/img/shell-integration/zdotdir.png)
_Enable ZDOTDIR handling checkbox_
...
_Image unavailable: Fish Cygwin Integration Example._
...
<a id="compress-progress-bar-output"></a>
...
<a id="inherit-environment-variables"></a>

### Inherit environment variables

See the corresponding setting or workflow described on this page.

<a id="enable-powershell-counter-workaround"></a>

### Enable PowerShell counter workaround

See the corresponding setting or workflow described on this page.

<a id="enable-oh-my-zsh-integration"></a>

### Enable Oh My Zsh integration

See the corresponding setting or workflow described on this page.

<a id="enable-powerlevel10k-integration"></a>

### Enable Powerlevel10k integration

See the corresponding setting or workflow described on this page.

<a id="enable-zdotdir-handling"></a>
